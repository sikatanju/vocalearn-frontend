                    ...
                    <div className="container mx-auto px-4 py-20 md:py-32">
                        <div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto">
                            ...
                            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl leading-relaxed">
                                Break language barriers with instant
                                translation, speech-to-text conversion, and
                                AI-powered pronunciation assessment across 150+
                                languages.
                            </p>

                            <div className="flex flex-col sm:flex-row gap-4 pt-4 hover:cursor-pointer">
                                <Link
                                    to={
                                        isAuthenticated
                                            ? '/translate'
                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                            ...
                            <Card className="relative group hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary/50 overflow-hidden">
                                ...
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-base">
                                        Convert audio to text in 100+ languages
                                        with precision
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                ...
                <section className="py-20 md:py-32 bg-muted/5 border-y border-border">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                The most comprehensive language learning
                                platform
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Get instant results with our optimized
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Support for text, audio, and file
                                        uploads across all features
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <Card className="relative overflow-hidden border-2">
                                ...
                                <CardContent className="relative p-12 text-center">
                                    ...
                                    <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                                        ...
                                        VocaLearn to master new languages. Start
                ...
                <footer className="border-t border-border py-12 bg-muted/5">
                    <div className="container mx-auto px-4">
                        <div className="grid md:grid-cols-4 gap-8 mb-8">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Breaking language barriers with AI-powered
                                    tools for translation, transcription, and
                                    pronunciation.
                                </p>
                            </div>
                            <div>
                        ...
                        <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
                            <p>
                                © {new Date().getFullYear()} VocaLearn. All
                                rights reserved.
                            </p>
                        </div>
                    </div>
